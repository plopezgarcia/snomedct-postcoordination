...
public final class TopLevelConcept {
    ...
    public enum SUBHIERARCHY {  BS, CF, EG, EV, OE, OR, PB, PF, PO,
    							PR, QV, RA, SI, SO, SP, SN, ST, SU, SM}


    // Probably useless... here anyway for now
    public static final Map<SUBHIERARCHY, String> SUBHIERARCHY_MAPPINGS;
    static {
    	Map<SUBHIERARCHY, String> theMap = new HashMap<SUBHIERARCHY, String>();
    	...
    	theMap.put(SUBHIERARCHY.SM, "900000000000441003");
